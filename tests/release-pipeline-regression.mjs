...
assert.equal(manifest.releaseVersion,'v1.15.0');
...
assert.doesNotMatch(html,/epic-stacker\.js\?v=1\.15\.0/,'Source-deployment cache numbers must not leak into the production artifact.');
