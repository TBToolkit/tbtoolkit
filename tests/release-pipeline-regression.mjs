...
assert.equal(manifest.releaseVersion,'v1.13.1');
...
assert.doesNotMatch(html,/epic-stacker\.js\?v=1\.13\.1/,'Source-deployment cache numbers must not leak into the production artifact.');
