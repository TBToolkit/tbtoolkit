...
assert.equal(manifest.releaseVersion,'v1.14.0');
...
assert.doesNotMatch(html,/epic-stacker\.js\?v=1\.14\.0/,'Source-deployment cache numbers must not leak into the production artifact.');
