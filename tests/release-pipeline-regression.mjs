...
assert.equal(manifest.releaseVersion,'v1.15.2');
...
assert.doesNotMatch(html,/epic-stacker\.js\?v=1\.15\.2/,'Source-deployment cache numbers must not leak into the production artifact.');
