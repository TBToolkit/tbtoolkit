...
export const COMBAT_MECHANICS_BUILD = '196';
export const EPIC_MECHANICS_BUILD = '196';
export const BATTLE_SIMULATOR_BUILD = '192';
export const PVP_ENGINE_BUILD = '196';
export const WORKSPACE_MODEL_BUILD = '191';
export const EPIC_COMBAT_ENGINE_BUILD = '2.4-bonus-profiles';
